...
def get_room_names():
    ...
    fenixTagusPOSTData = '_request_checksum_=f67a3295c65e704ecd76a260bd9c1c154de2248f&' \
        ...
        'net_sourceforge_fenixedu_dataTransferObject_spaceManager_FindSpacesBean_764323587_campuspostback=&' \
        'net.sourceforge.fenixedu.dataTransferObject.spaceManager.FindSpacesBean%3A764323587%3Acampus=net.sourceforge.fenixedu.domain.space.Campus%3A2465311230082&' \
    ...
    f = urllib.urlopen(fenixScheduleUrl,
                        fenixTagusPOSTData)
    html = f.read()
    f.close()
